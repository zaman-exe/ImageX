...
class ResultPage extends StatefulWidget {
  final File image;
 final String result;
  ResultPage({Key key, @required this.image, this.result,}) : super(key: key);

  @override
  State<StatefulWidget> createState() => ResultPageState(this.image,this.result);
}
...
class ResultPageState extends State<ResultPage> {
  ...
  ResultPageState(this.image, this.result);
